...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210525_gastbywordpress_731714db2315e0a98556_20210525151222_archive.zip';
	const ARCHIVE_SIZE		 = '35227870';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '731714d-25151222';
    const SECONDARY_PACKAGE_HASH = 'dea7fdd-25151222';
	const VERSION			 = '1.4.0';
